...
public class MusicManager implements Disposable
{
	...
	public void play(BackgroundMusic music)
	{
		...
		// do some logging
		Gdx.app.log(Pong.LOG, "Playing music: " + music.getName());
	...
	public void stop()
	{
		...
		{
			Gdx.app.log(Pong.LOG, "Stopping current music");
	...
	{
		Gdx.app.log(Pong.LOG, "Adjusting music volume to: " + volume);
	...
	public void dispose()
	{
		Gdx.app.log(Pong.LOG, "Disposing music manager");
		stop();
	}
}